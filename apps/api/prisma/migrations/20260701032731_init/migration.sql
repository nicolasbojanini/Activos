-- CreateEnum
CREATE TYPE "Rol" AS ENUM ('COORDINADOR', 'AUDITOR');
...
-- CreateIndex
CREATE INDEX "Activo_organizacionId_codigoQR_idx" ON "Activo"("organizacionId", "codigoQR");

-- CreateIndex
CREATE UNIQUE INDEX "Activo_organizacionId_placa_key" ON "Activo"("organizacionId", "placa");
...
-- AddForeignKey
ALTER TABLE "ProyectoAuditoria" ADD CONSTRAINT "ProyectoAuditoria_organizacionId_fkey" FOREIGN KEY ("organizacionId") REFERENCES "Organizacion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RegistroAuditoria" ADD CONSTRAINT "RegistroAuditoria_auditorId_fkey" FOREIGN KEY ("auditorId") REFERENCES "Usuario"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
